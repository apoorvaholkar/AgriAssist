...
import VegetationDetails from './VegetationDetails';
            ...
            <div>
              ...
              <div className="main-content">
                <Suspense fallback={<div>Loading...</div>}>
                  {activeSection === 'dashboard' && (
                    <>
                      <TempChart className="Tempchart margin-top: 20px" />
                      ...
                      {/* <div className="ndvi-plot-container">
                        <img 
                          src="http://localhost:5000/static/ndvi_plot.png" 
                          alt="NDVI Plot - Not Found" 
                          className="ndvi-plot"
                        />
                      </div> */}
                    </>
                  ...
                  {activeSection === 'vegetationdetails' && <VegetationDetails />} 
                </Suspense>
